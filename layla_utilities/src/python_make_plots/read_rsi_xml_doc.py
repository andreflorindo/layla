...
def read_path(robot_state_from_file):
    i = 0
    infile = open(
        # '/home/andreflorindo/workspaces/layla_motion_planner_ws/src/layla_utilities/trial_txt_files/14_11_2019/10_angle_spline_rsi.txt', 'r')
        '/home/andreflorindo/workspaces/layla_motion_planner_ws/src/layla_utilities/trial_txt_files/03_12_2019/rsi_const_laydown_speed.txt', 'r')
